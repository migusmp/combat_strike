  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.footerContent}>
        <div className={styles.footerBrand}>
          ...
          <p className={styles.footerMotto}>
            Operativa moderna, mentalidad táctica y defensa personal avanzada
            para quienes protegen lo que importa.
          </p>
        ...
        {!isAuthenticated && (
          <div className={styles.footerCTA}>
            ...
            <p>
              Programas presenciales y online con instructores especializados en
              protección civil y operativa.
            </p>
      ...
      <div className={styles.footerBottom}>
        <span>
          © {currentYear} DL Combat Strike · Todos los derechos reservados
        </span>
